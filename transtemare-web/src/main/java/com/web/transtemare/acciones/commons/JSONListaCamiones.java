...
public class JSONListaCamiones extends ActionSupport{

	private Logger logger = Logger.getLogger(JSONListaCamiones.class);
	...
	private String term;
	 ...
	 public JSONListaCamiones(Fachada fac) {
		super();
		this.fac = fac;
	}

	@Action(value = "/jsonListaCamiones", results = {
	 ...
	 public String execute()  {
		...
		try {
			fac.obtenerTodosLosCamiones(camiones);
