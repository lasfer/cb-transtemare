...
public class JSONListaClientes extends ActionSupport {

	private Logger logger = Logger.getLogger(JSONListaClientes.class);
	private static final long serialVersionUID = 1L;
	private Fachada fac;
	private ArrayList<String> lista;
	private String term;

	public JSONListaClientes(Fachada fac) {
		super();
		this.fac = fac;
	}

	@Action(value = "/jsonListaClientes", results = { @Result(type = "json", name = "success", params = {
			"root", "lista" }) })
	public String execute() {
		...
		try {
			fac.obtenerEmpresasPorTipo(empresa, Empresa.CLIENTE);
