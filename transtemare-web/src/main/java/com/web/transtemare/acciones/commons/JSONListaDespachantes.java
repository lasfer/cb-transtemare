...
public class JSONListaDespachantes extends ActionSupport {

	private Logger logger = Logger.getLogger(JSONListaDespachantes.class);
	private static final long serialVersionUID = 1L;
	private Fachada fac;
	private ArrayList<String> lista;
	private String term;

	public JSONListaDespachantes(Fachada fac) {
		super();
		this.fac = fac;
	}

	@Action(value = "/jsonListaDespachantes", results = { @Result(type = "json", name = "success", params = {
			"root", "lista" }) })
	public String execute() {
		...
		try {
			fac.obtenerEmpresasPorTipo(empresa, Empresa.DESPACHANTE);
