...
public class JSONListaEmpresas extends ActionSupport {

	private Logger logger = Logger.getLogger(JSONListaEmpresas.class);
	private static final long serialVersionUID = 1L;
	private Fachada fac;
	private ArrayList<String> lista;
	private String term;

	public JSONListaEmpresas(Fachada fac) {
		super();
		this.fac = fac;
	}

	@Action(value = "/jsonListaEmpresas", results = { @Result(type = "json", name = "success", params = {
			"root", "lista" }) })
	public String execute() {
		...
		try {
			fac.obtenerEmpresasPorTipo(empresa, Empresa.EMPRESA);
