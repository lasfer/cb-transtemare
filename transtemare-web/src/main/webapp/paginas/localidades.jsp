...
<div id="reloate" align="center">
	...
	<sjg:grid autoencode="false" id="gridedittable" caption="Localidades" width="650"
		...
		<sjg:gridColumn name="descripcion" index="descripcion"
			...
			editrules="{required: true}" width="90" />
		...
		<sjg:gridColumn name="aduana" index="aduana" title="Es Aduana"
			...
			editoptions="{value:'true:false'}" width="55" />
		<sjg:gridColumn name="codigoAduana" index="codigoAduana" title="Codigo Aduana"
			editable="true" edittype="text" width="55" editoptions="{size: 7, maxlength: 3}" editrules="{required: false, number:true}" />
	</sjg:grid>
</div>
