...
public class SQLCarpetas {
	...
	public static final String MODIFICAR_CARPETA = "UPDATE "
			...
			+ "validoHasta=?, rutasCorto=?, rutasLargo=?,transportadoraCamionSustituto=? , nombreFirmaDestinatario=?,  terminal=? where idCarpeta=?";
	...
	public static final String OBTENER_CANTIDAD_TERMINALES = "SELECT count(*) as total FROM" + SQLTablas.TABLA_TERMINALES + "  where activo=1 and id !=0";
	public static final String OBTENER_TERMINALES = "SELECT * FROM " + SQLTablas.TABLA_TERMINALES + "  where activo=1  and id !=0 " ;
	public static final String OBTENER_TERMINALES_POR_ID = "SELECT * FROM " + SQLTablas.TABLA_TERMINALES + " where id=? and activo=1  and id !=0 ";
	public static final String OBTENER_TERMINALES_DESDE_HASTA = "SELECT * FROM " + SQLTablas.TABLA_TERMINALES + " where activo=1 and id !=0  LIMIT ? , ?";
	public static final String COUNT_TERMINALES = "SELECT count(*) as total FROM " + SQLTablas.TABLA_TERMINALES + " where activo=1  and id !=0 ";
	public static final String ALTA_TERMINAL = "INSERT INTO " + SQLTablas.TABLA_TERMINALES + " values(null,?,1)";
	public static final String ACTUALIZAR_TERMINAL = "UPDATE " + SQLTablas.TABLA_TERMINALES + " SET nombre=? where id=? ";
	public static final String ELIMINAR_TERMINAL = "UPDATE " + SQLTablas.TABLA_TERMINALES + " SET activo=false where id=? ";
